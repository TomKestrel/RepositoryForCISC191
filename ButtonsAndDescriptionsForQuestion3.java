	...
	// 						itself (without creating an instance of the class).
	{
		...
		tier1Button.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				costSliderInstance.question3IncreaseSliderValueTier1(); // call the method to increase slider value
				new Question4Page(costSliderInstance);	//eventually change to 3
			}
		});
		...
		tier2Button.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				question3PageInstance.dispose();
				costSliderInstance.question3IncreaseSliderValueTier2(); // call the method to increase slider value
		...
		tier3Button.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				question3PageInstance.dispose();
				costSliderInstance.question3IncreaseSliderValueTier3(); // call the method to increase slider value
				new Question4Page(costSliderInstance);
			}
		});
		...
		tier4Button.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				question3PageInstance.dispose();
				costSliderInstance.question3IncreaseSliderValueTier4(); // call the method to increase slider value
				new Question4Page(costSliderInstance);
			}
		});
