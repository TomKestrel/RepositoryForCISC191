 ...
 * Contains all the framework for the JFrame "Question2Page" that the users will interact
 */

public class Question2Page extends JFrame // Question2Page IS-A JFrame
{	
	public Question2Page(CostSlider costSlider)
	{
		...
		ButtonsAndDescriptionsForQuestion2.addButtonsMethodForQuestion2(centerPanelNorth, this, costSlider);
		ButtonsAndDescriptionsForQuestion2.addDescriptionsMethodforQuestion2(centerPanelSouth);
		
		JLabel question1 = new JLabel();
		question1.setText("<html><br><br>Entertainment is important. How much do you spend on entertainment per month?<br><br>Movie tickets, minigolf, game microtransaction purchases, netflix subscription, etc.");
