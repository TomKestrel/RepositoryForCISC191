...
public class Question5Page extends JFrame // Question4Page IS-A JFrame
{	
	public Question5Page(CostSlider costSlider)
	{
		...
		ButtonsAndDescriptionsForQuestion5.addButtonsMethodForQuestion5(centerPanelNorth, this, costSlider);
		ButtonsAndDescriptionsForQuestion5.addDescriptionsMethodforQuestion5(centerPanelSouth);
		
		JLabel question1 = new JLabel();
		question1.setText("<html><br><br>What is your monthly rent cost?");
